...
const save= (vehiclenumber,policyno,coverno,policyfrom,fulllast,fullfirst,fullmiddle,gender,buildingname,streetname,landmark,city,taluka,district,pincode,state) =>{
