...
const save= (vhr,policyno,coverno,policyfrom,policytill,fulllast,fullfirst,fullmiddle,gender,buildingname,streetname,landmark,city,taluka,district,pincode,state) =>{
